...
include { methodsDescriptionText } from '../subworkflows/local/utils_nfcore_microscopycellpose_pipeline'
...
workflow MICROSCOPYCELLPOSE {
    ...
    softwareVersionsToYAML(ch_versions)
        .collectFile(
            ...
            name: 'nf_core_'  +  'microscopycellpose_software_'  + 'mqc_'  + 'versions.yml',
            sort: true,
            newLine: true
